...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-200 via-white to-gray-400 flex items-center justify-center">
      <div className="flex flex-col w-[530px] bg-gray-800 mt-[100px] mb-[100px] mx-auto pb-[30px]">
